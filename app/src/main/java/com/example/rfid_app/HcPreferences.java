...
public class HcPreferences {
     ...
     */
    @Deprecated
    public HcPreferences initSharedPreferences(SharedPreferences sp) {
        this.sp = sp;
        return this;
    }
     ...
     * @return                                          继续执行其他方法
     */
    public HcPreferences initSharedPreferences(SharedPreferences sp, ChangeSharedPreferencesPathCallBack changeSharedPreferencesPathCallBack) {
        this.sp = sp;
    ...
    public HcPreferences setChangeSharedPreferencesPathCallBack(ChangeSharedPreferencesPathCallBack changeSharedPreferencesPathCallBack) {
        this.changeSharedPreferencesPathCallBack = changeSharedPreferencesPathCallBack;
        return this;
    }
}
